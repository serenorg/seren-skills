#!/usr/bin/env python3
"""Dry-run-first operator runtime for co-invest-direct-deal-pipeline-crm."""
...
SKILL_NAME = 'co-invest-direct-deal-pipeline-crm'
ISSUE_NUMBER = 943
PILLAR = 'investment-operations'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-co-invest-direct-deal-pipeline-crm'
DATABASE_NAME = 'family_office_co_invest_direct_deal_pipeline_crm'
STATE_TABLES = ['deal_intake', 'investment_policy_rubric', 'deal_scores', 'stage_gate_ledger', 'artifact_checklist', 'value_creation_milestones', 'pipeline_health_rollups']
REQUIRED_OUTPUTS = ['ranked_deal_queue', 'screen_recommendations', 'stage_gate_status', 'required_artifacts', 'pipeline_health_rollup', 'post_close_milestone_alerts']
HANDOFFS = ['client-sourced-deal-review-memo', 'manager-dd-direct-co-investment', 'new-business-diligence-memo']
AVAILABLE_CONNECTORS = ['calendar', 'docreader', 'docs', 'drive', 'gmail', 'outlook', 'passwords', 'sheets', 'storage']
DEFAULT_PROFILE = {'title': 'Co Invest Direct Deal Pipeline CRM Operator', 'priority': 'P1', 'cadence': 'daily-inbound-deal-intake-weekly-pipeline-rollup-quarterly-health-review', 'gate': 'advancing to IC, requesting information, allocation, close, and post-close external follow-up require human approval', 'sample_subject': 'Three inbound co-investment opportunities for IC1 screening', 'exception_flags': ['missing_required_artifact', 'policy_fit_gap'], 'actions': ['ingest_deal_batch', 'score_against_policy', 'update_stage_gates', 'draft_screen_recommendations', 'produce_pipeline_rollup'], 'outputs': ['ranked_deal_queue', 'screen_recommendations', 'stage_gate_status', 'required_artifacts', 'pipeline_health_rollup', 'post_close_milestone_alerts'], 'handoffs': ['client-sourced-deal-review-memo', 'manager-dd-direct-co-investment', 'new-business-diligence-memo'], 'always_review': True}
