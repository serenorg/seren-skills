#!/usr/bin/env python3
"""Dry-run-first operator runtime for governance-charter-ai-digital-social-refresh."""
...
SKILL_NAME = 'governance-charter-ai-digital-social-refresh'
ISSUE_NUMBER = 946
PILLAR = 'governance'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-governance-charter-ai-digital-social-refresh'
DATABASE_NAME = 'family_office_governance_charter_ai_digital_social_refresh'
STATE_TABLES = ['charter_source_documents', 'policy_gap_matrix', 'proposed_insertions', 'topic_rationale', 'redline_packets', 'council_review_tasks']
REQUIRED_OUTPUTS = ['redline_ready_insertions', 'rationale_by_topic', 'topic_tags', 'council_review_packet', 'version_control_handoff']
HANDOFFS = ['family-governance-charter', 'governance-document-version-control']
AVAILABLE_CONNECTORS = ['docreader', 'docs', 'drive', 'outlook', 'passwords', 'search', 'storage']
DEFAULT_PROFILE = {'title': 'Governance Charter AI Digital Social Refresh Operator', 'priority': 'P1', 'cadence': 'annual-charter-refresh-or-policy-gap-event', 'gate': 'adoption, publication, and version-control promotion require human approval', 'sample_subject': 'Current family charter needs AI and digital assets refresh', 'exception_flags': ['missing_current_policy', 'council_approval_required'], 'actions': ['read_current_charter', 'map_policy_gaps', 'draft_topic_insertions', 'annotate_rationale', 'stage_council_review'], 'outputs': ['redline_ready_insertions', 'rationale_by_topic', 'topic_tags', 'council_review_packet', 'version_control_handoff'], 'handoffs': ['family-governance-charter', 'governance-document-version-control'], 'always_review': True}
