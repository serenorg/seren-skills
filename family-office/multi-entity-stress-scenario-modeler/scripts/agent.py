#!/usr/bin/env python3
"""Dry-run-first operator runtime for multi-entity-stress-scenario-modeler."""
...
SKILL_NAME = 'multi-entity-stress-scenario-modeler'
ISSUE_NUMBER = 949
PILLAR = 'investment-operations'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-multi-entity-stress-scenario-modeler'
DATABASE_NAME = 'family_office_multi_entity_stress_scenario_modeler'
STATE_TABLES = ['entity_map', 'position_snapshots', 'commitment_cashflows', 'scenario_definitions', 'stress_results', 'liquidity_gap_alerts', 'intercompany_funding_paths']
REQUIRED_OUTPUTS = ['scenario_outputs', 'liquidity_gap_alerts', 'policy_pass_fail_book', 'interentity_funding_paths', 'commitment_ledger_context']
HANDOFFS = ['commitment-cashflow-ledger-operator', 'cashflow-forecast-worksheet', 'cash-position-and-liquidity-monitor']
AVAILABLE_CONNECTORS = ['docreader', 'docs', 'drive', 'outlook', 'passwords', 'sheets', 'storage']
DEFAULT_PROFILE = {'title': 'Multi Entity Stress Scenario Modeler Operator', 'priority': 'P1', 'cadence': 'monthly-scenario-refresh-quarterly-ic-book-event-driven-cap-call-cluster', 'gate': 'funding calls, entity transfers, rebalancing, and external manager instructions require human approval', 'sample_subject': 'Three-entity cap-call cluster stress', 'exception_flags': ['liquidity_gap', 'policy_band_fail'], 'actions': ['load_entity_position_commitment_files', 'run_rate_shock', 'run_equity_drawdown', 'run_cap_call_cluster', 'draft_scenario_book'], 'outputs': ['scenario_outputs', 'liquidity_gap_alerts', 'policy_pass_fail_book', 'interentity_funding_paths', 'commitment_ledger_context'], 'handoffs': ['commitment-cashflow-ledger-operator', 'cashflow-forecast-worksheet', 'cash-position-and-liquidity-monitor'], 'always_review': True}
