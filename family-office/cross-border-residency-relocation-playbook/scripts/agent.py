#!/usr/bin/env python3
"""Dry-run-first operator runtime for cross-border-residency-relocation-playbook."""
...
SKILL_NAME = 'cross-border-residency-relocation-playbook'
ISSUE_NUMBER = 940
PILLAR = 'tax-and-entity-administration'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-cross-border-residency-relocation-playbook'
DATABASE_NAME = 'family_office_cross_border_residency_relocation_playbook'
STATE_TABLES = ['principal_profile', 'entity_residency_map', 'asset_tax_delta', 'relocation_calendar', 'action_checklist', 'reporting_obligations', 'advisor_handoff_log']
REQUIRED_OUTPUTS = ['tax_delta_model', 'relocation_playbook', 'reporting_calendar', 'per_asset_action_list', 'advisor_handoff_packet']
HANDOFFS = ['tax-strategy-memo', 'cpa-tax-package-checklist', 'trust-situs-selection-memo']
AVAILABLE_CONNECTORS = ['calendar', 'docreader', 'docs', 'drive', 'outlook', 'passwords', 'storage']
DEFAULT_PROFILE = {'title': 'Cross Border Residency Relocation Playbook Operator', 'priority': 'P1', 'cadence': 'event-driven-pre-move-weekly-checklist-until-closeout', 'gate': 'tax filings, identity refreshes, advisor instructions, and government submissions require human approval', 'sample_subject': 'Principal relocation from California to Portugal', 'exception_flags': ['exit_tax_review', 'fatca_crs_reclassification'], 'actions': ['build_pre_move_tax_delta', 'generate_exit_entry_checklists', 'refresh_fatca_crs_review_queue', 'produce_reporting_calendar'], 'outputs': ['tax_delta_model', 'relocation_playbook', 'reporting_calendar', 'per_asset_action_list', 'advisor_handoff_packet'], 'handoffs': ['tax-strategy-memo', 'cpa-tax-package-checklist', 'trust-situs-selection-memo'], 'always_review': True}
