#!/usr/bin/env python3
"""Dry-run-first operator runtime for quarterly-manager-letter-triage."""
...
SKILL_NAME = 'quarterly-manager-letter-triage'
ISSUE_NUMBER = 937
PILLAR = 'investment-operations'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-quarterly-manager-letter-triage'
DATABASE_NAME = 'family_office_quarterly_manager_letter_triage'
STATE_TABLES = ['manager_letter_ingest', 'fund_period_letters', 'material_event_ledger', 'quarterly_delta_log', 'portfolio_watchlist', 'k1_package_tracker', 'source_artifact_citations']
REQUIRED_OUTPUTS = ['per_fund_summary', 'prior_quarter_delta', 'material_event_register', 'portfolio_watchlist', 'manager_fund_monitor_context']
HANDOFFS = ['manager-fund-monitor', 'manager-dd-private-equity', 'client-sourced-deal-review-memo']
AVAILABLE_CONNECTORS = ['docreader', 'docs', 'drive', 'gmail', 'outlook', 'passwords', 'sheets', 'storage']
DEFAULT_PROFILE = {'title': 'Quarterly Manager Letter Triage Operator', 'priority': 'P1', 'cadence': 'quarterly-letter-window-daily-ingest-weekly-watchlist', 'gate': 'principal routing, manager outreach, and investment-committee escalation require human approval', 'sample_subject': 'Q2 GP letter strategy drift and key-person update', 'exception_flags': ['material_event_detected', 'prior_quarter_delta'], 'actions': ['ingest_quarterly_letters', 'extract_material_events', 'diff_prior_quarter', 'draft_principal_summary', 'update_watchlist'], 'outputs': ['per_fund_summary', 'prior_quarter_delta', 'material_event_register', 'portfolio_watchlist', 'manager_fund_monitor_context'], 'handoffs': ['manager-fund-monitor', 'manager-dd-private-equity', 'client-sourced-deal-review-memo'], 'always_review': True}
