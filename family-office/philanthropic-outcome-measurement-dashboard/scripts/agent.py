#!/usr/bin/env python3
"""Dry-run-first operator runtime for philanthropic-outcome-measurement-dashboard."""
...
SKILL_NAME = 'philanthropic-outcome-measurement-dashboard'
ISSUE_NUMBER = 945
PILLAR = 'philanthropy'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-philanthropic-outcome-measurement-dashboard'
DATABASE_NAME = 'family_office_philanthropic_outcome_measurement_dashboard'
STATE_TABLES = ['grant_portfolio', 'kpi_definitions', 'grantee_report_extracts', 'evaluator_inputs', 'outcome_dashboard', 'drift_alerts', 'source_citations']
REQUIRED_OUTPUTS = ['impact_dashboard', 'drift_alerts', 'kpi_source_citations', 'evaluator_input_summary', 'disbursement_handoff']
HANDOFFS = ['grant-pipeline-disbursement-operator', 'family-philanthropy-strategic-plan', 'foundation-payout-compliance-monitor']
AVAILABLE_CONNECTORS = ['docreader', 'docs', 'drive', 'exa', 'gmail', 'outlook', 'passwords', 'search', 'sheets', 'storage']
DEFAULT_PROFILE = {'title': 'Philanthropic Outcome Measurement Dashboard Operator', 'priority': 'P1', 'cadence': 'monthly-grantee-report-ingest-quarterly-impact-dashboard', 'gate': 'grantee outreach, disbursement changes, and family distribution require human approval', 'sample_subject': 'Education grants KPI update and evaluator notes', 'exception_flags': ['kpi_drift_detected', 'missing_source_artifact'], 'actions': ['ingest_grant_kpis', 'extract_report_updates', 'merge_evaluator_inputs', 'score_theory_of_change_drift', 'draft_family_dashboard'], 'outputs': ['impact_dashboard', 'drift_alerts', 'kpi_source_citations', 'evaluator_input_summary', 'disbursement_handoff'], 'handoffs': ['grant-pipeline-disbursement-operator', 'family-philanthropy-strategic-plan', 'foundation-payout-compliance-monitor'], 'always_review': True}
