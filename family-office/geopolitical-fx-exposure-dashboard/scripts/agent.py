#!/usr/bin/env python3
"""Dry-run-first operator runtime for geopolitical-fx-exposure-dashboard."""
...
SKILL_NAME = 'geopolitical-fx-exposure-dashboard'
ISSUE_NUMBER = 947
PILLAR = 'risk-management'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-geopolitical-fx-exposure-dashboard'
DATABASE_NAME = 'family_office_geopolitical_fx_exposure_dashboard'
STATE_TABLES = ['position_exposure', 'operating_company_revenue', 'country_exposure_map', 'sanctions_screen_results', 'supply_chain_concentration', 'hedge_recommendations', 'policy_band_checks']
REQUIRED_OUTPUTS = ['fx_net_exposure', 'country_exposure_dashboard', 'sanctions_screen', 'supply_chain_flags', 'hedge_trade_recommendations', 'policy_band_check']
HANDOFFS = ['cash-position-and-liquidity-monitor', 'portfolio-risk-register', 'target-asset-allocation-model']
AVAILABLE_CONNECTORS = ['docreader', 'drive', 'exa', 'news', 'outlook', 'passwords', 'sanctions', 'search', 'sheets', 'storage']
DEFAULT_PROFILE = {'title': 'Geopolitical FX Exposure Dashboard Operator', 'priority': 'P1', 'cadence': 'daily-exposure-refresh-weekly-policy-band-review-event-driven-sanctions-screen', 'gate': 'hedge trade routing, position changes, and external advisor instructions require separate human approval', 'sample_subject': 'EUR cash and operating company revenue exposure review', 'exception_flags': ['exposure_above_policy_band', 'sanctions_review_hit'], 'actions': ['calculate_fx_netting', 'map_country_and_sanctions_exposure', 'flag_supply_chain_concentration', 'draft_hedge_recommendations'], 'outputs': ['fx_net_exposure', 'country_exposure_dashboard', 'sanctions_screen', 'supply_chain_flags', 'hedge_trade_recommendations', 'policy_band_check'], 'handoffs': ['cash-position-and-liquidity-monitor', 'portfolio-risk-register', 'target-asset-allocation-model'], 'always_review': True}
