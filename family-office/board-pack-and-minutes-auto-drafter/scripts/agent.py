#!/usr/bin/env python3
"""Dry-run-first operator runtime for board-pack-and-minutes-auto-drafter."""
...
SKILL_NAME = 'board-pack-and-minutes-auto-drafter'
ISSUE_NUMBER = 944
PILLAR = 'governance'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-board-pack-and-minutes-auto-drafter'
DATABASE_NAME = 'family_office_board_pack_and_minutes_auto_drafter'
STATE_TABLES = ['transcript_ingest', 'minutes_drafts', 'decisions_log', 'action_items', 'source_artifact_index', 'prior_meeting_followups', 'approval_ledger']
REQUIRED_OUTPUTS = ['draft_minutes_doc', 'action_item_list', 'decisions_log', 'board_pack_appendix', 'followup_status']
HANDOFFS = ['family-meeting-agenda-minutes-template', 'family-council-cycle-operator', 'governance-document-version-control']
AVAILABLE_CONNECTORS = ['calendar', 'docreader', 'docs', 'drive', 'gmail', 'models', 'outlook', 'passwords', 'storage']
DEFAULT_PROFILE = {'title': 'Board Pack And Minutes Auto Drafter Operator', 'priority': 'P1', 'cadence': 'event-driven-after-meeting-transcript-ingest', 'gate': 'publishing, distribution, and permanent governance-record updates require human approval', 'sample_subject': 'Family council quarterly meeting transcript', 'exception_flags': ['owner_low_confidence', 'approval_required_before_distribution'], 'actions': ['ingest_transcript', 'infer_actions_and_decisions', 'cross_reference_prior_minutes', 'draft_board_pack_appendix', 'stage_human_review'], 'outputs': ['draft_minutes_doc', 'action_item_list', 'decisions_log', 'board_pack_appendix', 'followup_status'], 'handoffs': ['family-meeting-agenda-minutes-template', 'family-council-cycle-operator', 'governance-document-version-control'], 'always_review': True}
