---
name: k1-1099-tracking-chase
description: "Family office: Tracks expected k-1 and 1099 documents, mines inboxes and portals for arrivals, matches receipts, files documents, and drafts review-gated chasers."
---

# Family Office · K1 1099 Tracking Chase

## For Claude: How to Use This Skill

Skill instructions are preloaded in context when this skill is active. Do not perform filesystem searches or tool-driven exploration to rediscover them; use the guidance below directly.

This is a recurring family-office operator skill, not a memo generator. Run it to operationalize `cpa-tax-package-checklist` as a stateful, approval-gated employee.

## When to Use

- track missing K-1s
- run 1099 receipt chase
- assemble CPA tax package documents
- check expected tax documents

## Operating Contract

This operator tracks expected K-1 and 1099 documents, mines inboxes and portals for arrivals, matches receipts, files documents, and drafts review-gated chasers. It belongs to `Tax & Regulatory Compliance Operations` in the Citi family-office functions frame and is priority `P0` from roadmap issue #852.

Approval gate: chase emails and CPA package pushes are review-gated. The agent stages review packets, audit rows, reminders, and draft communications. It does not submit money movement, government filings, binding notices, beneficiary changes, or external instructions without the live gate and human approval.

## Schema Guard

Before any read or write, resolve or create the SerenDB project `family-office-k1-1099-tracking-chase` and database `family_office_k1_1099_tracking_chase`. Verify or create these tables:
...
- `match_document_receipts`
- `open_chase_task`
- `draft_cpa_package_delta`

## Cloud Deployment

Deploy as a seren-cloud cron or event-triggered worker with the default Python runtime. Suggested cadence: `daily-tax-season-mining-weekly-chase-cycle`. Do not use Docker, a local pull runner, or customer-specific local paths.
...
```bash
python3 -m pytest family-office/k1-1099-tracking-chase/tests -q
python3 family-office/k1-1099-tracking-chase/scripts/agent.py --functional-test --config family-office/k1-1099-tracking-chase/config.example.json
