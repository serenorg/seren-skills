#!/usr/bin/env python3
"""Dry-run-first operator runtime for cyber-incident-response-runbook."""
...
SKILL_NAME = 'cyber-incident-response-runbook'
ISSUE_NUMBER = 941
PILLAR = 'risk-management'
DEFAULT_DRY_RUN_TO = 'taariq@serendb.com'
PROJECT_NAME = 'family-office-cyber-incident-response-runbook'
DATABASE_NAME = 'family_office_cyber_incident_response_runbook'
STATE_TABLES = ['incident_register', 'containment_tasks', 'credential_rotation_ledger', 'evidence_preservation_log', 'notification_templates', 'post_incident_review']
REQUIRED_OUTPUTS = ['incident_runbook', 'containment_task_list', 'evidence_collection_checklist', 'principal_notification_draft', 'post_incident_review_template']
HANDOFFS = ['credential-hygiene-breach-monitor', 'password-management-setup-plan', 'family-risk-management-plan']
AVAILABLE_CONNECTORS = ['calendar', 'docreader', 'docs', 'drive', 'gmail', 'outlook', 'passwords', 'storage']
DEFAULT_PROFILE = {'title': 'Cyber Incident Response Runbook Operator', 'priority': 'P0', 'cadence': 'event-driven-incident-response-post-incident-review', 'gate': 'outbound communications, account freezes, vendor instructions, and regulator or law-enforcement reports require human approval', 'sample_subject': 'Lost device with mailbox OAuth exposure', 'exception_flags': ['compromised_identity', 'credential_rotation_required'], 'actions': ['classify_incident', 'stage_containment_tasks', 'generate_evidence_checklist', 'draft_principal_notification', 'open_post_incident_review'], 'outputs': ['incident_runbook', 'containment_task_list', 'evidence_collection_checklist', 'principal_notification_draft', 'post_incident_review_template'], 'handoffs': ['credential-hygiene-breach-monitor', 'password-management-setup-plan', 'family-risk-management-plan'], 'always_review': True}
