...
4. Verify the configured hedge ticker, `strict_required_feeds`, and `live_controls` still fit the account before submitting orders.
5. If any required feed, credential, or account preflight fails, stop here and fail closed instead of submitting orders.
