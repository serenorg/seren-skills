#!/usr/bin/env python3
"""Poll seren-cron local pull jobs for high-throughput-paired-basis-maker."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the high-throughput-paired-basis-maker seren-cron local pull runner."
    )
