#!/usr/bin/env python3
"""Manage seren-cron local pull schedules for high-throughput-paired-basis-maker."""
...
DEFAULT_JOB_NAME = "polymarket-htpbm-local-pull"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manage seren-cron local pull schedules for high-throughput-paired-basis-maker."
    )
