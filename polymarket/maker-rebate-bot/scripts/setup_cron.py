#!/usr/bin/env python3
"""Manage seren-cron local pull schedules for polymarket-maker-rebate-bot."""
...
DEFAULT_JOB_NAME = "polymarket-maker-rebate-local-pull"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manage seren-cron local pull schedules for polymarket-maker-rebate-bot."
    )
    ...
    create.add_argument(
        ...
        choices=("backtest", "monitor", "quote"),
