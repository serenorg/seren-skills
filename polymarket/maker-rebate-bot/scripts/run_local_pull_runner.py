#!/usr/bin/env python3
"""Poll seren-cron local pull jobs for polymarket-maker-rebate-bot."""
...
DEFAULT_RUN_TYPE = "quote"
MAX_TAIL_CHARS = 4000


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the polymarket-maker-rebate-bot seren-cron local pull runner."
    )
